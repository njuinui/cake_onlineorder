   ...
   $_SESSION['signup'] = 'Please add avatar';
    ...
    if (isset($_SESSION['signup'])) {
      ...
      die();
        ...
        $insert_user_query = "INSERT INTO users(fname, lname, uname, email, password,address,contact, photo,status) VALUES ('$firstname', '$lastname', '$username', '$email', '$hashed_password','$address','$phone','$avatar_name','Pendding')";
        $insert_user_result = mysqli_query($connection, $insert_user_query);
        if (!mysqli_errno($connection)) {
            //redirect to login page with success message            
            $_SESSION['user_id'] = $user_record['photo'];
